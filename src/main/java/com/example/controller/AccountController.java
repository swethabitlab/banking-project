...
import com.example.dto.PinRequest;
import com.example.dto.PinUpdateRequest;
...
public class AccountController {
    ...
    public ResponseEntity<?> cashWithdrawal(@RequestBody AmountRequest amountRequest) {
        accountService.cashWithdrawl(LoggedinUser.getAccountNumber(), amountRequest.getPin(), amountRequest.getAmount());
